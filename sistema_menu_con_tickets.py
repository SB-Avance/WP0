...
class SistemaMenuConTickets:
    ...
    def _procesar_respuesta_captura(self, respuesta: str, telefono: str, estado: EstadoUsuario) -> Dict:
        ...
        if hay_mas_preguntas:
            ...
            self._log(f"❓ Capturando respuesta {len(datos.respuestas)} para {telefono}")
    ...
    def _crear_ticket_en_dataverse(self, datos: DatosCaptura, telefono: str) -> Optional[str]:
        """
    ...
    def _procesar_seleccion_submenu(self, mensaje: str, telefono: str, estado: EstadoUsuario) -> Dict:
        ...
        self._log(f"✅ Selección: {subopcion.texto} → Grupo: {subopcion.grupo_asignado}")
    ...
    def _es_cache_valido(self) -> bool:
        ...
        expiration = self._cache_timestamp + timedelta(minutes=MenuConfig.CACHE_DURATION_MINUTES)
        return datetime.now() < expiration
    ...
    def _obtener_menu_hardcoded(self) -> List[OpcionPrincipal]:
        ...
        return [
            OpcionPrincipal(
                ...
                subopciones=[
                    SubOpcion("1.1", "Incidente Técnico", "Soporte Técnico", "Solicitud Ticket"),
                    SubOpcion("1.2", "Solicitud Servicio", "Service Desk", "Solicitud Ticket"),
                    SubOpcion("1.3", "Cambio", "Gestión de Cambios", "Solicitud Ticket"),
                ]
            ),
            OpcionPrincipal(
                numero=2,
            ...
            OpcionPrincipal(
                ...
                subopciones=[
                    SubOpcion("3.1", "Hablar con Asesor", "Atención al Cliente", "Solicitar Atención"),
                    SubOpcion("3.2", "Atención Urgente", "Equipo de Urgencias", "Solicitar Atención"),
                ]
            ),
        ]
...
if __name__ == "__main__":
    ...
    sistema = SistemaMenuConTickets(
        ...
        token_provider_func=mock_token
    )
