...
def TemplatesView(on_back=None, api_base_url="http://localhost:5000", token=None):
                ...
                ft.Container(
                    ft.Column(
                        [
                            ...
                            ft.Text(
                                "Haz clic en 'Nuevo Template' para crear uno",
                                size=12,
                            ...
                            [
                                ...
                                ft.Column(
                                    [
                                        ...
                                        ft.Text(
                                            f"Categoría: {template['categoria']}",
                                            size=12,
    ...
    def render_form():
        ...
        # Construir botones
        buttons = [
            ft.ElevatedButton("Guardar", icon=ft.icons.SAVE, on_click=save_template)
        ]
        if edit_mode["value"]:
    ...
    controls.append(
        ft.Container(
            ft.ElevatedButton(
                "Nuevo Template", icon=ft.icons.ADD, on_click=new_template_click
            ),
