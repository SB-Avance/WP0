...
def DashboardView(
    on_back=None, on_group_change=None, current_group=None, available_groups=None
):
    controls = []
    if on_back:
        controls.append(
    ...
    if on_group_change:
        ...
        controls.append(
            ft.Text("Categoría de Conversaciones", size=16, weight=ft.FontWeight.BOLD)
        )
        controls.append(
            ft.Text("Selecciona el grupo para categorizar los chats:", size=12)
        )
