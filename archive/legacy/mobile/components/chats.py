...
def ChatsView(
            ...
            content=ft.Row(
                [
                    ...
                    ft.Column(
                        [
                            ft.Text(
                                timestamp[:16].replace("T", " ") if timestamp else "",
                                size=11,
        ...
        group_filter = ft.Container(
            content=ft.Row(
                [
                    ...
                    ft.Dropdown(
                        options=[
                            ft.dropdown.Option(key=g, text=g) for g in available_groups
                        ],
                        value=current_group,
    ...
    return ft.Container(
        ft.ListView(
            content_list, expand=True, spacing=0, padding=ft.padding.only(top=10)
        ),
        expand=True,
    )
