...
class HandlerH001(BaseHandler):
    ...
    def get_preguntas(self) -> List[str]:
        ...
        return ["🚨 Describe la *urgencia* lo más detallado posible:"]
...
Error técnico: {str(e)[:50]}
    ...
    def _enviar_notificaciones_multicanal(
        self, ticket_id: str, descripcion: str, telefono: str
    ):
        """
