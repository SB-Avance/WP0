...
from sistema_menu_confiable import (MenuConfig, SistemaMenuConfiable,
                                    crear_sistema_menu)
...
class IntegracionMenuWhatsApp:
    ...
    def procesar_mensaje_usuario(self, mensaje: str, telefono: str) -> dict:
        ...
        if mensaje_lower in ["menu", "menú", "opciones", "hola", "hi"]:
            return {"tipo": "menu", "texto": self.menu.obtener_menu_texto()}
...
if __name__ == "__main__":
    ...
    try:
        ...
        mensajes_prueba = ["hola", "1", "opcion 2", "99", "menu", "texto aleatorio"]
        ...
        for mensaje in mensajes_prueba:
            ...
            print(
                f"   {respuesta['texto'][:100]}{'...' if len(respuesta['texto']) > 100 else ''}"
            )
