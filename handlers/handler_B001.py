...
class HandlerB001(BaseHandler):
    ...
    def ejecutar_accion_final(
        ...
        # Obtener respuestas
        asunto = respuestas.get("¿Cuál es el *asunto* de tu solicitud?", "Solicitud de servicio")
        descripcion = respuestas.get("Por favor, describe brevemente tu *solicitud de servicio*", "Sin descripción")
