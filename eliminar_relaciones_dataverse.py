...
if len(sys.argv) != 3:
    print("Uso: python eliminar_relaciones_dataverse.py <tabla_logica> <columna_logica>")
    sys.exit(1)
...
def main():
    ...
    if not relaciones:
        print(f"No se encontraron relaciones para la columna {logical_column} en la tabla {logical_table}")
        return
